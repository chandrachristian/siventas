	...
	<header class="main-header">
		...
		<a href="#" class="logo">
			...
			<img src="/dist/img/favicon-32x32.png" type="image/png" sizes="16x16" class="logo-mini">
			<!-- <span class="logo-mini" href>IB</span> -->
			<!-- logo for regular state and mobile devices -->
			<span class="logo-lg">Siventas <b>Fasilkom</b></span>
		</a>
