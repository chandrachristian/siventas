@if(isset($inventaris))
        ...
        <div class="form-group">
            ...
            <input type="date" name="tanggal_register" class="form-control" value="{{ date('Y-m-d',strtotime($inventaris->tanggal_register)) }}">
        </div>
...
@else
        ...
        <div class="form-group">
            ...
            <input type="date" name="tanggal_register" class="form-control" value="{{ date('Y-m-d',time()) }}">
        </div>
        <button type="submit" class="btn btn-success">Submit</button>
        <a href="/inventaris" class="btn btn-danger">Cancel</a>
@endif